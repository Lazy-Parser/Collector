...
const file_PushDataV3ApiWrapper_proto_rawDesc = "" +
	"\n" +
	"\x1aPushDataV3ApiWrapper.proto\x1a PublicAggreBookTickerV3Api.proto\"\xc6\x02\n" +
	...
	"\v_createTimeB\v\n" +
	"\t_sendTimeBb\n" +
	"\x1ccom.mxc.push.common.protobufB\x19PushDataV3ApiWrapperProtoH\x01P\x01Z#github.com/Lazy-Parser/Collector/pbb\x06proto3"
...
var file_PushDataV3ApiWrapper_proto_depIdxs = []int32{
	1, // 0: PushDataV3ApiWrapper.publicAggreBookTicker:type_name -> PublicAggreBookTickerV3Api
