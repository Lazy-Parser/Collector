...
// TODO: set limitation not hardcoded
...
// Important! Network must be in dexscreener type. It can be changed with Chain service
func (api *DexscreenerAPI) GetTokenPairs(ctx context.Context, network string, address string) (*DexscreenerResponse, error) {
